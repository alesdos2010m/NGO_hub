...
public class LoginBackgroundWorker extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url="http://192.168.43.94/login.php";
        if(type.equals("signin"))
        {
            try {
                ...
                String post_data= URLEncoder.encode("email_id","UTF-8")+"="+URLEncoder.encode(email_id,"UTF-8")+"&"+ URLEncoder.encode("password","UTF-8")+"="+URLEncoder.encode(password,"UTF-8");
